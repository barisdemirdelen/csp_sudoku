...
Main program will solve sudokus from input file and write the solutions to the output file.
...
def create_sudoku_constraints(variables):
	...
	On index 0 is the cell in the left uppercorner, on index 80 is the cell on the bottom rightcorner.
